 ...
 *
 * Usage: node .agents/scripts/set-active-plan.cjs <plan-path>
 *
...
if (!newPlan) {
  ...
  console.log('Usage: node .agents/scripts/set-active-plan.cjs <plan-path>');
  console.log('Example: node .agents/scripts/set-active-plan.cjs plans/251207-1030-feature-name');
  process.exit(1);
}
