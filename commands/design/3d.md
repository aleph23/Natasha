...
0. **FIRST**: Run `ui-ux-pro-max` searches for 3D design context:
   ...
   python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "immersive 3d" --domain style
   python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "animation" --domain ux
   ```
