...
1. **FIRST**: Run `ui-ux-pro-max` searches to gather design intelligence:
   ...
   python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "<mood>" --domain typography
   python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "<industry>" --domain color
   ```
