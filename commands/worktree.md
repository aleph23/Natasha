...
```bash
node .agents/scripts/worktree.cjs info --json
```
...
**Monorepo:**
```bash
node .agents/scripts/worktree.cjs create "<PROJECT>" "<SLUG>" --prefix <TYPE> --env "<FILES>"
```

**Standalone:**
```bash
node .agents/scripts/worktree.cjs create "<SLUG>" --prefix <TYPE> --env "<FILES>"
```
...
Claude: [Runs: node .agents/scripts/worktree.cjs info --json]
...
Claude: [Runs: node .agents/scripts/worktree.cjs create "login-validation-bug" --prefix fix --env ".env.example"]
