...
```bash
python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "accessibility" --domain ux
python3 $HOME/.agents/skillsui-ux-pro-max/scripts/search.py "z-index animation" --domain ux
```
