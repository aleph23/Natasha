...
```bash
python .agents/scripts/ck-help.py "$ARGUMENTS"
```
...
- Use global (~/.agents/.ck.json) for personal preferences like language, issue prefix style
- Use local (./.agents/.ck.json) for project-specific paths, naming conventions
