...
**Special cases:**
- `.agents/` skill updates: `perf(skill): improve git-manager token efficiency`
- `.agents/` new skills: `feat(skill): add database-optimizer`
...
```
Files: .agents/commands/new.md, src/feature.ts, package.json
Split into:
