...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `./.agents/workflows/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `./.agents/workflows/development-rules.md` and `./docs/code-standards.md`
