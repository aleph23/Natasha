...
**Examples:**
- `app/posts/` - Project catalog/post management
- `app/blogs/` - Blog builder and rendering
...
**Pattern:**
```typescript
// app/my-feature/api/myFeatureApi.ts
...
| `@app` | `src/features` | Feature imports |
...
import { postApi } from '@app/posts/api/postApi';
...
import type { Props, Theme } from '@mui/material';
...
import { MyFeatureMain, useMyFeature } from '@app/my-feature';

// ❌ Avoid deep imports (but OK if needed)
import { MyFeatureMain } from '@app/my-feature/components/MyFeatureMain';
```
