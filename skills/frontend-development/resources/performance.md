...
export const Parent = : React.ReactElement | null =>
 {
...
export const SearchComponent = : React.ReactElement | null =>
 {
...
export const List = { items }: React.ReactElement | null =>
 {
...
const ChildComponent = : React.ReactElement | null =>
 <div>Child</div>;
...
export const Parent = { config }: React.ReactElement | null =>
 {
