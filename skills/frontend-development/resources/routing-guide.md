...
const PostsList = lazy(() =>
    import('@/app/posts/components/PostsList').then(
...
const MyPage = lazy(() =>
    import('@/app/my-feature/components/MyPage').then(
...
const MyPage = lazy(() => import('@/app/my-feature/components/MyPage'));
```
...
const UserProfile = lazy(() =>
    import('@/app/users/components/UserProfile').then(
