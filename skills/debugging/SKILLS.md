...
2. **Data Collection**
   ...
   - Read the latest docs of the packages/plugins
...
1. **Executive Summary**
   - Issue description and describe programmatic flow
   - Attempt root cause identification
   - Recommended solutions and potential paths toward solutions
...
3. **Actionable Recommendations**
   - Fixes with implementation steps
...
- Consider security implications of both issue and solution
