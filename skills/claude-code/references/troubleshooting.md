...
chmod +x .agents/scripts/hook.sh

# Test hook script manually
.agents/scripts/hook.sh

# Check logs
cat ~/.agents/logs/hooks.log
```
...
# Recent logs
tail -n 100 ~/.agents/logs/session.log
