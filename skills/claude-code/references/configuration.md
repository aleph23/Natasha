...
3. **Project settings** (`.agents/settings.json`)
4. **Global settings** (`~/.agents/settings.json`)
...
Create `~/.agents/output-styles/my-style.md`:
...
### Project Settings
- Keep project-specific in `.agents/settings.json`
